  ...
  return (
    <ScrollView style={styles.container}>
      <ScrollView style={{ flex: 1 }}>
        ...
        <Image
          source={{
            uri: 'https://thumbs.dreamstime.com/b/car-wash-scene-colorful-soap-water-splashing-creating-vibrant-dynamic-atmosphere-filled-bubbles-foam-340257116.jpg',
          }}
          style={{ width: windowWidth, height: windowHeight / 2.7 }}
        />
